...
|---|---|---|
| I | Defect-Fix-First with Characterised Legacy | **PASS.** Oracle widens to progression's classes (goldens recorded by executing them, research §6). P1–P9 appended: P1/P2/P3/P4/P5/P9 FIXED with pinning tests named below; P6/P7 RETIRED; P8 MOOT. P3/P4 carry the sign-off marker (content-affecting). No uncatalogued behaviour change: everything not in a P row or a C row is bug-for-bug (notably C24's `####` in `PdfPayloadMapper`). |
