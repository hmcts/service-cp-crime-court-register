...
This project carries no Jira ticket (user decision, 2026-08-31): features use the sequential `001-...` naming (current: `001-court-register-port`) and work lands on plain `main`. The patched script still supports a Jira-id prefix if a ticketed workflow arrives later, via:
